...
export default async function AdminCourseDetailPage({
  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-3">
        {(lessons ?? []).map((lesson) => (
          <form
            ...
            className="flex flex-col gap-2 rounded-lg border border-purple-200/60 bg-white/60 p-3"
          >
      ...
      <form action={createLesson.bind(null, courseId)} className="mt-6 flex flex-col gap-2 rounded-lg border border-purple-200/60 bg-white/60 p-4">
