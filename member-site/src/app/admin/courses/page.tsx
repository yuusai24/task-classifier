...
export default async function AdminCoursesPage() {
  ...
  return (
    <div>
      ...
      <form action={createCourse} className="mb-8 flex flex-col gap-2 rounded-lg border p-4">
      ...
      <ul className="flex flex-col gap-2">
        {(courses ?? []).map((course) => (
          <li key={course.id} className="flex items-center justify-between rounded-lg border p-3">
