...
export default async function AdminAnnouncementsPage() {
  ...
  return (
    <div>
      ...
      <form action={createAnnouncement} className="mb-8 flex flex-col gap-2 rounded-lg border border-purple-200/60 bg-white/60 p-4">
      ...
      <ul className="flex flex-col gap-2">
        {(announcements ?? []).map((a) => (
          <li key={a.id} className="flex items-center justify-between rounded-lg border border-purple-200/60 bg-white/60 p-3">
            <div>
